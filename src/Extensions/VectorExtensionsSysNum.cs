...
/// </summary>
public static class VectorExtensionsSysNum
{
	/// <summary>
	...
	/// <summary>
	/// Converts a Matrix to a array of float
	/// </summary>
	/// <param name="m">The input vector.</param>
	/// <returns></returns>
	public static float[] ToArray(this in Matrix4x4 m)
	{
